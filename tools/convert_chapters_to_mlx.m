...
chapterMap = {
    "Ch00_HowToUseThisCourse.m", "Ch00_如何使用这套讲义.mlx"
    "Ch01_MATLABInterfaceAndLiveScript.m", "Ch01_MATLAB界面与LiveScript工作流.mlx"
    "Ch02_VariablesArraysIndexingSyntax.m", "Ch02_变量数组索引与基础语法.mlx"
    "Ch03_ScriptsFunctionsPathProjectStructure.m", "Ch03_脚本函数路径与工程化组织.mlx"
    "Ch04_ResearchPlottingBasics.m", "Ch04_科研绘图基础与图形规范.mlx"
    "Ch05_2D3DVisualizationFluxSurfaces.m", "Ch05_二维三维可视化与磁面图.mlx"
    "Ch06_DataIOAndExternalPaths.m", "Ch06_数据读写与外部数据路径配置.mlx"
};
